...
public class LLMController {
    ...
    @PostMapping("/ask")
    public ResponseEntity<ResAskDto> summarize(@RequestBody ReqUserPrompt prompt, Authentication authentication) {
    ...
    public ResponseEntity<ResGenDto> generate(@RequestBody ReqUserPrompt prompt, Authentication authentication) {
        List<LifeLogOutput> lifeLogOutputs = llmService.generateFromLLM(prompt.getPrompt(), authentication);
