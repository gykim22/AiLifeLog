...
import com.pnu.ailifelog.component.jwt.JwtAccessDeniedHandler;
import com.pnu.ailifelog.component.jwt.JwtAuthenticateFilter;
import com.pnu.ailifelog.component.jwt.JwtAuthenticationEntryPoint;
       ...
       return httpSecurity
            ...
            .authorizeHttpRequests(
                    auth -> auth
                            ...
                            .requestMatchers(HttpMethod.GET, "/api/v1/diary/**").permitAll() // 다이어리 조회 허용
